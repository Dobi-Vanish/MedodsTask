...
// ReadJSON Helper function to read JSON received information.
...
// WriteJSON Helper function to write JSON response.
...
// ErrorJSON Helper function to send standardized error responses.
